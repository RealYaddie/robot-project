...
# From the [INSERT NAME OF MODULE] module we get the position of the target in space
...
# Using the [INSERT NAME OF MODULE] module we first move the robot arm to the 'Home' position
# and then to the 'Target 1' position
# move the robot to the home position, and then to the center <- REMOVE
robot.MoveJ(home)
robot.MoveJ(target)

# Using the [INSERT NAME OF MODULE] moduele we're able to use a message box
...
# Using the [INSERT NAME OF MODULE] module we're able to 
...
# move back to the center, and then back to the home position
robot.MoveL(target)
robot.MoveJ(home)
